...
When we think of code, we often picture functionality—algorithms, instructions, logic. But code can also be expressive. Just as a brushstroke can carry emotion or a poem can bend language, code can shape time, space, and interaction. It can draw lines, simulate forces, and create experiences that unfold over time.
...
In *Precarious*, Utterback transforms the ephemeral nature of human presence into dynamic digital drawings. As participants move within the installation space, their silhouettes are captured and rendered as a series of points that interact with each other, creating ever-evolving forms. These outlines are not static; they shift, merge, and dissipate as new participants enter, illustrating the transient and interconnected nature of our interactions. The artwork becomes a living canvas, continuously rewritten by the collective movement of its viewers.
...
Nóbrega's *Possible, Plausible, Potential* embraces the unpredictability inherent in generative processes. Utilizing [Processing](https://processing.org/), he defines parameters within which randomness can unfold, allowing the code to partially dictate the outcome. The resulting pen plotter drawings are products of both intentional design and chance, reflecting a dialogue between artist and algorithm. This interplay challenges traditional notions of authorship and highlights the creative potential of relinquishing control.
...
Akkapeddi's *Decode Kolams* bridges cultural tradition and computational art by translating textual data into Kolam, a traditional art form from South India.  
...
By converting characters into binary code and mapping them onto a grid, Akkapeddi's algorithm generates intricate patterns that honor the mathematical complexity of Kolams. The combination of language, code, and cultural expression invites viewers to consider the intersections of heritage and technology. 
...
In *She Who Sees the Unknown*, Allahyari reimagines monstrous female/queer figures of Islamic origin. Using 3D modeling and digital fabrication, Allahyari resurrects these figures as well as their marginalized history. The work serves as a digital archive and a form of resistance, blending myth, technology, and activism.
...
*Doilies* merges traditional textile patterns with algorithmic design, resulting in intricate lace-like structures through code. This work explores the relationship between domestic crafts and computational processes, highlighting the aesthetic possibilities that arise when old-world techniques meet modern technology.

> The design of each doily in the series is based on a different enveloped virus structure (HIV, SARS, Influenza, Herpes, Hepadna). The radial symmetry of the doily and aesthetic conventions of lace are conflated with that of the virus structure. Here, the DNA, RNA, protein spikes, and lipid envelopes become unassuming decorative motif.
>
> \- Laura Splan 
...
Lozano-Hemmer's *Border Tuner / Sintonizador Fronterizo* is an interactive installation connecting communities across the U.S.-Mexico border. Participants on both sides engage in real-time conversations facilitated by light beams that respond to their voices. The work transforms a geopolitical divide into a space of dialogue and connection, emphasizing shared humanity through technological interaction.

>Border Tuner is not only designed to create new connections between the communities on both sides of the border, but to make visible the relationships that are already in place: magnifying existing relationships, conversations and culture.
> 
> \- Rafael Lozano-Hemmer
...
- How can creative coding shift the function of technology from surveillance or control to connection and communication?
